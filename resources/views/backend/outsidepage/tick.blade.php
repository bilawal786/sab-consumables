                                ...
                                <tr>
                                    <td class="esd-structure" align="left">
                                        <table width="100%" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="600" valign="top" align="center">
                                                    <img src="{{asset('/images/check.png')}}" style="width: 200px;margin: 10px;">
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tr>
                                                <td class="esd-container-frame" width="600" valign="top" align="center">
                                                    <table style="background-color: #ffecd1; border-radius: 4px; border-collapse: separate;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffecd1">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p30b es-p30r es-p30l" esdev-links-color="#ec2c2f" align="center"><a target="_blank" href="{{route('login')}}" style="color: #ec2c2f;">Link</a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
